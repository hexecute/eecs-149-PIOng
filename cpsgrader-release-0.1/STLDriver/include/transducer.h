...
public:
	...
	// We maintain globally (for all properties) trace_data, parameters and signal mapping
	static trace_data *trace_data_ptr;
	static map<string, double> param_map;
	static map<string, short> signal_map;
	...
	// compute neutral quantitative semantics for current data
